# ضع الملف ده جنب manage.py وشغّل:
#   python write_seed.py
# بعدين:
#   python manage.py seed_products

import os, sys

SEED = '''import random, uuid, requests
...
path = os.path.join(
    ...
    "stor", "management", "commands", "seed_products.py"
)
os.makedirs(os.path.dirname(path), exist_ok=True)
with open(path, "w", encoding="utf-8") as f:
    f.write(SEED)
print("OK => " + path)
print("Run: python manage.py seed_products")